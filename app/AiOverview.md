...
| `transport`      | `ConnectionBuilder`, `DefaultConnectionBuilder`, `InitiatingTransport`, `ListeningTransportBinding`                                                                                                           | Transport abstraction interfaces                                                          |
| `transport/tcp`  | `TcpInitiatingTransport`, `TcpListeningTransportBinding`, `TcpServer`, `SocketP2PInputStream`, `SocketP2POutputStream`, `SocketUtils`                                                                         | TCP transport implementation                                                              |
...
| `multistream`    | `Multistream`, `MultistreamFraming`, `ProtocolBinding`, `ProtocolDescriptor`, `ProtocolMatcher`, `ProtocolSelect`                                                                                             | Multistream-select negotiation                                                            |
