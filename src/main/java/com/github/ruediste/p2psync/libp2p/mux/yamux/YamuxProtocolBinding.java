 ...
 *
 * <p>
 * On {@link #init}, constructs a {@link YamuxSession} around the given
 ...
 */
public final class YamuxProtocolBinding implements ProtocolBinding<MuxerSession> {
    ...
    @Override
    public MuxerSession init(P2PStream stream, String selectedProtocol) {
        boolean initiator = stream.isInitiator();
        return new YamuxSession(stream.getIn(), stream.getOut(), initiator, inboundMultistream);
    }
}
